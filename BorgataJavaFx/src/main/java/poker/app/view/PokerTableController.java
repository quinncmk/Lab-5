...
public class PokerTableController {
	...
	@FXML
	public HBox hBoxP1Winning;
	@FXML
	public HBox hBoxP2Winning;
	@FXML
	public HBox hBoxP3Winning;
	@FXML
	public HBox hBoxP4Winning;
	...
	private void handleDraw() {
		...
		if (act.isbEvaluateHand()) {
			...
			if (WinningPlayer.getiPlayerPosition() == 1) {
				...
				ImageView img = new ImageView(new Image(getClass().getResourceAsStream(strCard), 60, 60, true, true));
				hBoxP1Winning.getChildren().add(img);
			} else if (WinningPlayer.getiPlayerPosition() == 2) {
				String strCard = "/res/img/winner.png";
				ImageView img = new ImageView(new Image(getClass().getResourceAsStream(strCard), 60, 60, true, true));
				hBoxP2Winning.getChildren().add(img);
			} else if (WinningPlayer.getiPlayerPosition() == 3) {
				String strCard = "/res/img/winner.png";
				ImageView img = new ImageView(new Image(getClass().getResourceAsStream(strCard), 60, 60, true, true));
				hBoxP3Winning.getChildren().add(img);
			} else if (WinningPlayer.getiPlayerPosition() == 4) {
				String strCard = "/res/img/winner.png";
				ImageView img = new ImageView(new Image(getClass().getResourceAsStream(strCard), 60, 60, true, true));
				hBoxP4Winning.getChildren().add(img);
			}
